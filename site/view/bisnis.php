 ...
 $c = $_GET['page'];
 $index_bisnis = $qM->index_bisnis($c); $hib = $qM->head_bisnis($c); ?>
 <!--main Container-->
    	<div class="col-lg-12 col-sm-12 col-xs-12">            
            	...
            	<div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 bg-dark margin-top heading-news">
                    ...
                    <div class="col-lg-3 col-sm-3 col-md-3 col-xs-3 padding-zero-left">
                     ...
                     <div class="col-lg-3 padding-zero-left">
                    	<div class="heading"><?php echo $c; ?></div>
                    </div>
                </div>
                <!--end heading-->
            ...
            <div class="col-lg-3 col-sm-3 col-xs-12 bg-white margin-top padding-zero">
            	<div class="title-orange">
                    ...
                    <?php $ns = $qM->bursa_saham(); foreach($ns as $n){ ?>
                    <a href="baca-<?php echo $n['post_url']; ?>"><div class="st"><?= $n['post_title'];  ?></div>
					<?= 'di baca '.$n['counter_page'].' kali'; ?></a>
                    <div class="hr"></div>
                    <?php } ?>
            </div>
            ...
            <div class="col-lg-3 col-sm-3 col-xs-12 bg-white margin-top padding-zero">
            	<div class="title-orange">
                    ...
                    <?php $ns = $qM->pasar_uang(); foreach($ns as $n){ ?>
                    <a href="baca-<?php echo $n['post_url']; ?>"><div class="st"><?= $n['post_title'];  ?></div>
					<?= 'di baca '.$n['counter_page'].' kali'; ?></a>
                    <div class="hr"></div>
                    <?php } ?>
            ...
            <div class="col-lg-3 col-sm-3 col-xs-12 bg-white margin-top padding-zero">
            	<div class="title-orange">
                    ...
                    <?php $ns = $qM->industri_dan_pertambangan(); foreach($ns as $n){ ?>
                    <a href="baca-<?php echo $n['post_url']; ?>"><div class="st"><?= $n['post_title'];  ?></div>
					<?= 'di baca '.$n['counter_page'].' kali'; ?></a>
                    <div class="hr"></div>
                    <?php } ?>
            ...
            <div class="col-lg-3 col-sm-3 col-xs-12 bg-white margin-top padding-zero">
            	<div class="title-orange">
                    ...
                    <?php $ns = $qM->properti(); foreach($ns as $n){ ?>
                    <a href="baca-<?php echo $n['post_url']; ?>"><div class="st"><?= $n['post_title'];  ?></div>
					<?= 'di baca '.$n['counter_page'].' kali'; ?></a>
                    <div class="hr"></div>
                    <?php } ?>
