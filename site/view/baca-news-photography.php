...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script></box2><box2><div class="fb-share-button" data-href="http://editor.id/foto-<?php echo $url; ?>" data-layout="button_count"></div></box2><box><?php echo '<img src="asset/img/read.png" width="15" height="15"> '.$d_b['counter_page'].' read'; ?></box>
                    </div>
            ...
            <div class="col-lg-9 col-sm-9 col-xs-12">
                <div class="col-lg-12 col-sm-12 col-xs-12 bg-white margin-top margin-rigth padding-zero">
                    ...
                    <!--form komentar ------------------------------------------------------------------------------>
                    	...
                    	<table class="comment">
                        	<form action="foto-<?php echo $d_b['post_url'] ?>" method="post">
                                <tr class="bg-dark">
                                    <td>
					...
					$comments = $qM->loadcomments($post_id);
						foreach ($comments as $cm){ ?>
                        	<div class="col-lg-12 col-md-12 col-sm-12 margin-bottom border">
								<div class="col-lg-2 col-md-2 user-coment">
                                	<img src="asset/img/comentator.png" class="img-coment" />
									<?php echo $cm['comentator']; ?>
                                </div>
