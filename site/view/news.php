 ...
 $c = $_GET['page'];
 $index_bisnis = $qM->index_news($c); $hib = $qM->head_news($c); ?>
 <!--main Container-->
    	<div class="col-lg-12 col-sm-12 col-xs-12">            
            ...
            <div class="col-lg-3 col-sm-3 col-xs-12 bg-white margin-top padding-zero">
            	<div class="title-orange">
                    ...
                    <?php $ns = $qM->nasional(); foreach($ns as $n){ ?>
            ...
            <div class="col-lg-3 col-sm-3 col-xs-12 bg-white margin-top padding-zero">
            	<div class="title-orange">
                    ...
                    <?php $ns = $qM->internasional(); foreach($ns as $n){ ?>
                    <a href="baca-<?php echo $n['post_url']; ?>"><div class="st"><?= $n['post_title'];  ?></div>
					<?= 'di baca '.$n['counter_page'].' kali'; ?></a>
                    <div class="hr"></div>
                    <?php } ?>
            ...
            <div class="col-lg-3 col-sm-3 col-xs-12 bg-white margin-top padding-zero">
            	<div class="title-orange">
                    ...
                    <?php $ns = $qM->daerah(); foreach($ns as $n){ ?>
                    <a href="baca-<?php echo $n['post_url']; ?>"><div class="st"><?= $n['post_title'];  ?></div>
					<?= 'di baca '.$n['counter_page'].' kali'; ?></a>
                    <div class="hr"></div>
                    <?php } ?>
            ...
            <div class="col-lg-3 col-sm-3 col-xs-12 bg-white margin-top padding-zero">
            	<div class="title-orange">
                    ...
                    <?php $ns = $qM->jabodetabek(); foreach($ns as $n){ ?>
                    <a href="baca-<?php echo $n['post_url']; ?>"><div class="st"><?= $n['post_title'];  ?></div>
					<?= 'di baca '.$n['counter_page'].' kali'; ?></a>
                    <div class="hr"></div>
                    <?php } ?>
