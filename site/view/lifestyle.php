 ...
 $c = $_GET['page'];
 $index_bisnis = $qM->index_lifestyle($c); $hib = $qM->head_lifestyle($c); ?>
 <!--main Container-->
    	<div class="col-lg-12 col-sm-12 col-xs-12">            
            ...
            <div class="col-lg-3 col-sm-3 col-xs-12 bg-white margin-top padding-zero">
            	<div class="title-orange">
                    ...
                    <?php $ns = $qM->kesehatan(); foreach($ns as $n){ ?>
            ...
            <div class="col-lg-3 col-sm-3 col-xs-12 bg-white margin-top padding-zero">
            	<div class="title-orange">
                    ...
                    <?php $ns = $qM->iptek(); foreach($ns as $n){ ?>
                    <a href="baca-<?php echo $n['post_url']; ?>"><div class="st"><?= $n['post_title'];  ?></div>
					<?= 'di baca '.$n['counter_page'].' kali'; ?></a>
                    <div class="hr"></div>
                    <?php } ?>
            ...
            <div class="col-lg-3 col-sm-3 col-xs-12 bg-white margin-top padding-zero">
            	<div class="title-orange">
                    ...
                    <?php $ns = $qM->teknologi_informasi(); foreach($ns as $n){ ?>
                    <a href="baca-<?php echo $n['post_url']; ?>"><div class="st"><?= $n['post_title'];  ?></div>
					<?= 'di baca '.$n['counter_page'].' kali'; ?></a>
                    <div class="hr"></div>
                    <?php } ?>
            ...
            <div class="col-lg-3 col-sm-3 col-xs-12 bg-white margin-top padding-zero">
            	<div class="title-orange">
                    ...
                    <?php $ns = $qM->manajemen(); foreach($ns as $n){ ?>
                    <a href="baca-<?php echo $n['post_url']; ?>"><div class="st"><?= $n['post_title'];  ?></div>
					<?= 'di baca '.$n['counter_page'].' kali'; ?></a>
                    <div class="hr"></div>
                    <?php } ?>
